...
//        http.csrf().disable() // отключаем защиту от межсайтовой подделки запросов. Так делать не надо
        http
                ...
                .requestMatchers("/authentication", "/error", "/registration", "/resoutces/**", "static/**", "css/**", "js/**", "/img/**").permitAll() // Указываем, что неаутентифицированные пользователи могут зайти на страницу аутентификации и на объект ошибки
